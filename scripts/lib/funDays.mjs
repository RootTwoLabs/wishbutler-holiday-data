...
/**
 * FUN liefert alle 17 App-Locales = `LOCALES` (seit origin/main 4756771 sind
 * da, fi, nb, ru, uk dort enthalten), damit kuriose Feiertage in keiner
 * App-Sprache auf den englischen Fallback fallen.
 */
